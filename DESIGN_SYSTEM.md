...
This document defines reusable semantic language for Observatory's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain observational, calm, high-signal, explorable, and honest about confidence and coverage while allowing product-specific identity to vary inside Ego Hygiene's broader family.
